...
let
  ...
  wrapExeWithRedirects = exe: ''
    wrapProgram "${exe}" \
        ...
        --set NIX_REDIRECTS "${
          lib.concatStringsSep ":" (map (redir: "${redir.dest}=${redir.src}") serviceRedirects)
        }"
  '';

  # https://github.com/BOPOHA/aws-rpm-packages/tree/644dd964b7a6325c38087e1542ff73bcfa753d2b
  patchPrefix = "https://raw.githubusercontent.com/BOPOHA/aws-rpm-packages/644dd964b7a6325c38087e1542ff73bcfa753d2b/awsvpnclient";
  patchInfos = [
    {
      url = "${patchPrefix}/acvc.gtk..deps.patch";
      sha256 = "sha256-ShVMUyJOk+Zq7XnU8vpgl2BxbKQM1asE5hm8/OcLvU0=";
    }
    {
      url = "${patchPrefix}/awsvpnclient.deps.patch";
      sha256 = "sha256-6XI1WInzb7rFzeEq5wSYTpkE6DQbuTCMlMNSUbR/Dk8=";
    }
    # {
    #   url = "${patchPrefix}/awsvpnclient.desktop.patch";
    #   sha256 = "sha256-PUcqKrl7k5n6QTYHScct/wDVlwLumojIi/73PRiN5kw=";
    # }
    {
...
in
makeOverridable guiFHS (import ./version.nix)
